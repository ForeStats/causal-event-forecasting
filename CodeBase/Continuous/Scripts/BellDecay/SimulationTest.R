...
g_t <- data.frame(t_intvl = 1:11, g_t_fun = c(sqrt(seq(0, 100, 25)), sqrt(seq(100, 0, -25)), 0) )
g_t$g_t_fun <- g_t$g_t_fun/sum(g_t$g_t_fun*g_t_bw)

g_xy_breaks = c(seq(0, 0.1, 0.01), 2)
g_xy_bw = diff(g_xy_breaks)
g_xy <- data.frame(xy_intvl = 1:11, g_xy_fun = c(sqrt(seq(0, 100, 25)), sqrt(seq(100, 0, -25)), 0) )

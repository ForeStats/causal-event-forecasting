...
load("~/Documents/MyResearch/CodeBase/Discrete/Scripts/simdata.RData")
...
while(delta > 1e-4){
  ...
  mu_txym = mu_data[, list(mu = sum(p_ii)/(mu_t_bw*mu_x_bw*mu_y_bw)), by = c('bint', 'binx', 'biny', 'm')]
